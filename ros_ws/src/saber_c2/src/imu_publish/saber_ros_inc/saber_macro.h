...
#define CMD_ID_SET_MOUDLEID                     0x0C
#define CMD_ID_GET_MOUDLEID                     0x0D

	//class 0x03 CLASS_ID_SENSOR_CONFIG command
#define CMD_SET_ACC_SCALE                       0x01
#define CMD_GET_ACC_SCALE                       0x02
#define CMD_SET_ACC_COEFF                       0x03
#define CMD_GET_ACC_COEFF                       0x04
#define CMD_ID_SET_ACC_CALIBRATION              0x05
#define CMD_SET_GYRO_SCALE                      0x06
#define CMD_GET_GYRO_SCALE                      0x07
#define CMD_SET_MAG_SCALE                       0x0B
#define CMD_GET_MAG_SCALE                       0x0C
#define CMD_SET_MAG_COEFF                       0x0D
#define CMD_GET_MAG_COEFF                       0x0E
